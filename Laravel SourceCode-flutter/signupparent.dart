...
class _MyHomePageState extends State<signupparent> {
  ...
  Future register(BuildContext cont) async {
    if (firstname.text == "" ||
      ...
      Navigator.push(
        cont,
        MaterialPageRoute(builder: (context) => const mailnoice1()),
      );
      var Url = 'http://169.254.80.80/dicetutormobile/accountparent.php';
