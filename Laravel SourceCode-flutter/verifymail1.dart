...
class verifymail1 extends StatefulWidget {
  const verifymail1({Key? key}) : super(key: key);

  @override
  _MyHomePageState createState() => _MyHomePageState();
}

class _MyHomePageState extends State<verifymail1> {
  ...
  Future confirmed() async {
    if (digitvalue.text == "") {
      ...
      var url = 'http://169.254.80.80/dicetutormobile/digitverify1.php';
      ...
      if (data == "Success") {
        ...
        Navigator.push(
          context,
          MaterialPageRoute(builder: (context) => const confirmedmessage1()),
        );
      } else if (data == "Error") {
        debugPrint(data);
        Fluttertoast.showToast(
