...
import 'package:untitled2/tutorguarantor.dart';
import 'package:untitled2/tutorsignin.dart';
import 'package:http/http.dart' as http;
import 'package:untitled2/tutorupdateprofile.dart';


class tutoracademicdetails1 extends StatefulWidget {
  late String email;
  tutoracademicdetails1(this.email, {Key? key}) : super(key: key);

  // const tutorpersonaldetails2(String email, {Key? key}) : super(key: key);

  @override
  State<tutoracademicdetails1> createState() => _tutoracademicdetails1State();
}

class _tutoracademicdetails1State extends State<tutoracademicdetails1> {
  late String dropdownCity = 'Degree';
  var items =  ['Degree','B.Sc.','B.A.','B.Ed.','B.Eng','B.Tech.','Diploma.','MBBS','HND','OND','M.Sc.','LL.B','MBA','PhD',
    'N.C.E' ,'S.S.C.E'];
  ...
  Future editProfile1(BuildContext cont) async {
    if (dropdownCity == "" ||
      ...
      var Url = 'http://192.168.43.29/dicetutormobile/tutorEdit4.php';
      ...
      if (data == "Success") {
        Navigator.of(context).push(MaterialPageRoute(builder: (context)=>tutorguarantor(email.text)));
      } else {}
              ...
              child: Center(
                child: GestureDetector(
                  ...
                  child: const Align(
                    ...
                    child: Text(
                      "Add more qualification(if not Skip)",
